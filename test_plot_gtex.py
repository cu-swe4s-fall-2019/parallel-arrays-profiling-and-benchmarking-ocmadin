...
class TestBinarySearch(unittest.TestCase):
    def test_input_type_key(self):
        self.assertRaises(TypeError, pgtx.binary_search,None,[1,2,3])
        self.assertRaises(TypeError,pgtx.binary_search,[1,2,3],[1,2,3])

    def test_input_type_L(self):
        self.assertRaises(TypeError, pgtx.binary_search,1,None)
        self.assertRaises(TypeError,pgtx.binary_search,1,1)
        self.assertRaises(TypeError,pgtx.binary_search,1,'test')
    def test_no_hit(self):
